...
import { BeneficiarySchema, BulkBeneficiaryUploadSchema } from "@/lib/validation";
...
import ButtonAddEditSaccoGroup from "../../sacco-group/button-add-edit-sacco-group";
                  ...
                  {field.value ? (
                    <ChosenSaccoGroupCommandItem
                      saccoGroup={saccoGroups.find(
                        (saccoGroup) => saccoGroup.name === field.value,
                      )}
                    />
                  ) : (
                    "Choose saccoGroup..."
                  ...
                  <CommandGroup className="">
                    {saccoGroups.map((saccoGroup) => (
                      <CommandItem
                        ...
                        onSelect={() => {
                          form.setValue("enterpriseGroupName", saccoGroup.name);
                          form.clearErrors("enterpriseGroupName");
                          setOpen(false);
                        }}
                        className="w-full min-w-2xs"
                      >
                        <CommandItemSaccoGroup
                          isChecked={field.value === saccoGroup.name}
